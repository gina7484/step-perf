...
#[context_macro]
pub struct LinearOffChipLoadRef<E: LoggableEventSimple, T: DAMType, R: DAMType> {
...
impl<
        ...
        T: npyz::Deserialize + DAMType,
        R: DAMType,
    > Context for LinearOffChipLoadRef<E, T, R>
where
    Elem<Tile<T>>: DAMType,
    Elem<R>: DAMType,
{
